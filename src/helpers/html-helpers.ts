export class HTMLHelper { 
  static populateAnimalTable(animalsRow: HTMLElement, animalTemplate: HTMLTemplateElement, animals: IAnimal[]): void {
  ...
  static populateSpeciesTable(speciesRow: HTMLElement, speciesTemplate: HTMLTemplateElement, species: IAnimalsBySpecies[]): void {
    ...
    species.forEach(speciesItem => {
      ...
      clone.querySelector('.species-count')!.textContent = speciesItem._count.toString();
